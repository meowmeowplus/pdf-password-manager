...
Just copy .claude-code-review/ folder and run: python .claude-code-review/install.py

Features:
- 🎯 Trigger: "deep review code" 
...
class CodeReviewInstaller:
    ...
    def install(self):
        ...
        if self.copy_config_files():
            ...
            print("❌ Failed to install configuration files")
        ...
        if self.setup_claude_hooks():
            ...
            print("⚠️  Claude Code hooks setup failed (may need manual setup)")
        ...
        if success_count >= 3:
            ...
            print("\nPartial installation. Some manual setup may be required.")
    ...
    def setup_claude_hooks(self):
        ...
        try:
            ...
            print(f"   ⚙️  Settings saved to: {settings_file}")
            return True
    ...
    def update_gitignore(self):
        ...
        try:
            ...
            if "# Claude Code Review System" in existing_content:
                print("   ℹ️  .gitignore already contains code review entries")
                return True
...
'''
    ...
    def detect_project_type(self):
        ...
        if (self.repo_root / 'package.json').exists():
            ...
            return "Go"
        elif (self.repo_root / '.csproj').glob('*.csproj'):
            return "C#/.NET"
        else:
...
def main():
    ...
    if success:
        print("\n🎉 Ready to use! Try saying: 'deep review code'")
    else:
        print(f"\n📖 Manual setup may be required. Check the documentation.")
